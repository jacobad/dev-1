...
// Returns the private 'App\Repository\PicturesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PicturesRepository.php';

return $this->privates['App\Repository\PicturesRepository'] = new \App\Repository\PicturesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
