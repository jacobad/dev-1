...
class __TwigTemplate_dab1d1d7ba9d7cdeffd8c0d9aaacdec4a86c7a5593b93d07d80cc6127838d083 extends \Twig\Template
{
    private $source;
    ...
    public function block_vich_file_widget($context, array $blocks = [])
    {
        ...
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "file", []), 'widget');
        // line 9
        if (twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "delete", [], "any", true, true)) {
            // line 10
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "delete", []), 'row');
        }
        // line 13
    ...
    {
        return new Source("", "@VichUploader/Form/fields.html.twig", "C:\\wamp64\\www\\my-agence\\vendor\\vich\\uploader-bundle\\Resources\\views\\Form\\fields.html.twig");
    }
}
