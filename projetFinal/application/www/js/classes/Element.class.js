...
Element.prototype.addText = function()
{
	...
	$('#showForm').append('<fieldset><legend>Votre texte </legend><form action="'+getRequestUrl()+'/edit" method="POST" id="form"><textarea id="Text" name="Text"></textarea><button type="submit" >Envoyer</button></form>');
